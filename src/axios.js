...
const baseURL = process.env.NODE_ENV === 'development' ? "http://localhost:8888/.netlify/functions/server" : "https://cors-anywhere.herokuapp.com/https://weeblix.netlify.com/.netlify/functions/server"
